 ...
 * vn.viettel.browser.webservice.entity : NewsWebService
 */
@Entity
@Table(name = "filtered_hot_tags", schema = "webnewsdb")
public class FilteredHotTagsEntity {
    private int id;
    ...
    public boolean equals(Object o) {
        ...
        FilteredHotTagsEntity that = (FilteredHotTagsEntity) o;
